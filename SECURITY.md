...
The ZelAI team and community take the security of our gateway, credentials, and routing infrastructure seriously.
...
- ZelAI never phones home, collects telemetry, or sends your API keys to third-party tracking servers
- All data remains under your control at all times

### 2. Virtual Client Keys (`sr-live-...`)

- Clients and downstream applications interact with ZelAI using virtual API keys
...
If you discover a potential security vulnerability or sensitive information exposure in ZelAI, please do **NOT** disclose it in a public GitHub issue.

Please report it privately via:

- **Email**: `security@zelai.dev` (or open a private GitHub Security Advisory)
- **GitHub**: [Security Advisories](https://github.com/zelapii/Zrouter/security/advisories/new)
...
When deploying ZelAI, follow these recommendations:
...
- **Security issues**: `security@zelai.dev`
- **General questions**: [GitHub Discussions](https://github.com/zelapii/Zrouter/discussions)
- **Bug reports**: [GitHub Issues](https://github.com/zelapii/Zrouter/issues)
