import { CODEBUDDY_AUTH_PLATFORM, CODEBUDDY_AUTH_REFRESH_URL, CODEBUDDY_AUTH_STATE_URL, CODEBUDDY_AUTH_TOKEN_URL, CODEBUDDY_AUTH_USER_AGENT, CODEBUDDY_CN_AUTH_REFRESH_URL, CODEBUDDY_CN_AUTH_STATE_URL, CODEBUDDY_CN_AUTH_TOKEN_URL, CODEBUDDY_CN_DOMAIN, CODEBUDDY_CN_ORIGIN, CODEBUDDY_CN_USER_AGENT } from "@srouter/constants";
...
export class CodeBuddyOAuth {
    ...
    async exchangeCodeForTokens(code, _codeVerifier) {
    ...
    async refreshTokens(refreshToken) {
        try {
            ...
            if (this.refreshBearer)
                throw new Error("CodeBuddy token refresh failed");
        }
        catch (error) {
            if (this.refreshBearer) {
