...
const EMBEDDED_DEFAULT_PRICING = {
    input: 2.0,
    output: 8.0,
    cached: 1.0,
    reasoning: 12.0,
 ...
 */
export const DEFAULT_PRICING = loadedDataset.defaults || EMBEDDED_DEFAULT_PRICING;
/**
 * Canonical model pricing table loaded from pricing.jsonc / pricing.json.
 */
export const MODEL_PRICING = loadedDataset.models;
/**
 ...
 */
export const MODEL_ALIASES = loadedDataset.aliases;
