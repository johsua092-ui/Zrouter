 ...
 */
export function flattenModelPrices(models) {
    const flat = {};
 ...
 */
export function resolvePricingDataPath(customPath) {
    if (customPath)
        return customPath;
 ...
 */
export function loadPricingData(customPath) {
    ...
    const isGroupedArray = raw.models &&
    ...
    return {
        ...
        models: flatModels,
        providerModels: isGroupedArray ? raw.models : undefined,
        aliases: raw.aliases || {}
    };
}
/**
 ...
 */
export function resolveModelsDevDataPath(customPath) {
    if (customPath)
        return customPath;
    const currentDir = path.dirname(fileURLToPath(import.meta.url));
    const candidates = [
 ...
 */
export function loadModelsDevData(customPath) {
