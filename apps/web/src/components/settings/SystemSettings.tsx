...
export function SystemSettings({ apiBase }: SystemSettingsProps) {
    ...
    const handleCheckUpdates = () => {
        refetchVersion();
        toast.info("Checking GitHub for the latest ZelAI tags...");
    };
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <div>
                                <span className="text-xs font-bold text-foreground">
                                    New ZelAI Version Available ({latestVersion})
                                </span>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                    <div className="space-y-0.5">
                        ...
                        <p className="text-[11px] text-muted-foreground">
                            Measure roundtrip HTTP ping latency from browser to the ZelAI local
                            API daemon.
                        </p>
                    </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                    ...
                    >
                        <span className="flex items-center gap-2">
                            ...
                            <span>ZelAI GitHub Repository</span>
                        </span>
